		...
		<div class="col-md-12">
			...
			<table class="table">
                ...
                <tr class="active">
                    ...
                    <td>
                    	<a href="aedit?id=<c:out value='${techTalk.id}' />"><button type="submit" class="btn btn-primary"">
				                 Edit
			               </button></a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="adelete?id=<c:out value='${techTalk.id}' />"><button type="submit" class="btn btn-danger">
				                 Delete
			               </button></a>                    	
                    </td>
                </tr>
